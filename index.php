...
<head>
    ...
    <title>Sistema Escolar | TECNM</title>
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <h3 class="font-weight-light my-4"><b> Bienvenido</h3>
                                    <h4 class="font-weight-light my-4">Inicie Sesión</b></h4>
                                </div>
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1" for="clave"><i class="fas fa-key"></i> Contrase&ntilde;a</label>
