...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['clave'])) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO usuario(nombre,correo,usuario,clave) values ('$nombre', '$correo', '$usuario', '$clave')");
            if ($query_insert) {
...
<div class="table-responsive">
    ...
    <div class="Reportes">
                        <a class="btn btn-info" href="reportes/reporte_usuarios.php"><i class="fas fa-file-pdf"></i> Generar Reporte</a>
                    </div>
</div>
